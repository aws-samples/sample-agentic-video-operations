# Hydrolix CDN Insights - Front-End Implementation with Amplify

This tutorial guides you through setting up a React Web application that integrates with your **[Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/)** deployment, creating **Hydrolix CDN Insights** for CDN and Streaming Video Analytics.

> [!NOTE]
> **Working Directory**: Make sure you are in the `amplify-hydrolix-data-assistant-agentcore-strands/` folder before starting this tutorial. All commands in this guide should be executed from this directory.
...
Navigate to the React application folder (amplify-hydrolix-data-assistant-agentcore-strands/) and install the dependencies:
...
- ? Enter a name for the project: **`hydrolixassistant`**

Use the following default configuration:
- Name: **hydrolixassistant**
- Environment: dev
...
1. **Find your AuthRole**: Go to AWS Console → IAM → Roles → Search for `amplify-hydrolixassistant-dev-*-authRole`
...
4. **Save the policy** with a name like `HydrolixCDNInsightsPermissions`
